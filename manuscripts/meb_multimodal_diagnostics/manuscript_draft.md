...
**Table 3. Asymptotic envelope metrics for the developed high-power cases.**
...
**Table 4. Literature quantities needed for a quantitative MEB comparison dataset.**
...
**Table 5. Current uncertainty and quality-diagnostic status.**
...
2. Event markers identify distinct stages of the process. The DNB-associated heat-flux maximum and transition wall-temperature peak occur early, while the first sustained oscillation peak occurs later and defines the start of the envelope-analysis window for the developed oscillatory state.
