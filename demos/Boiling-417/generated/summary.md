...
| --- | --- |
| `test_id` | `Boiling-417` |
| `raw_folder` | `Y:\0_Ishraq\New Pool Boiling Video\Boiling-417` |
| `applied_heat_load_W_cm2` | `250.0` |
| `input_subcooling_C` | `57.6` |
| `duration_s` | `988.9` |
| `pressure_mean_kPa` | `97.51` |
| `pressure_std_kPa` | `0.05821346892999` |
| `pressure_rmse_vs_target_kPa` | `0.1966289020230798` |
...
| `plots_dir` | `demos\Boiling-417\generated\plots` |
| `dc_start_time_s` | `5.2279820000007495` |
...
| `ae_wfs_file` | `Y:\0_Ishraq\New Pool Boiling Video\Boiling-417\STREAM20260510-180215-533.wfs` |
| `ae_wfs_channel` | `1` |
